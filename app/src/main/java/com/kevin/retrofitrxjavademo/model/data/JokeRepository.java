...
public class JokeRepository {
    ...
    public JokeRepository(CompositeDisposable subscriptions) {
        this.mSubscriptions = subscriptions;
    }

    public Observable<JokeResult> getJokeById1(int id) {
        return HttpHelper.request(mSubscriptions, HttpBuilder.getJokeService().getJokeById1(id));
    }
}
